...
#define SECRET_TOKEN "198612He@"   // Token rahasia (harus sama di JSON server)
const char* update_json_url = "https://raw.githubusercontent.com/herdisidi12-ship-it/HERDI-SIDI/refs/heads/main/update.json";
